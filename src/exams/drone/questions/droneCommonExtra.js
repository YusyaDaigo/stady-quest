...

{
        ...
        question:
            "無人航空機の操縦者としての責任に関する説明のうち、不適切なものはどれか。",

        choices: [
            "補助者を配置していても最終的な安全責任は操縦者にある",
            "自動飛行機能を使用していても操縦者は飛行状況を監視する必要がある",
            "補助者が配置されている場合、事故時の責任は補助者へ移る"
        ],

        answer: 2,

        explanation:
            "補助者を配置していても安全運航の最終責任は操縦者にあります。"
},
        ...
        question:
            "安全管理の考え方として最も適切なものはどれか。",

        choices: [
            "法令を守れば安全管理は不要である",
            "リスクを特定し、許容可能な水準まで低減する",
            "事故が発生してから対策を考える"
        ],
        ...
        explanation:
            "安全管理ではリスクを把握し、許容可能なレベルまで低減することが重要です。"
},

{
        ...
        question:
            "飛行を中止すべき判断として最も適切なものはどれか。",

        choices: [
            "機体は正常だが操縦者が強い疲労を感じている",
            "飛行経験が豊富なので予定通り飛行する",
            "補助者がいるため操縦者の体調は考慮しない"
        ],

        answer: 0,

        explanation:
            "疲労は判断力低下につながるため飛行を見合わせるべきです。"
},

{
        ...
        question:
            "飛行後の対応として最も適切なものはどれか。",

        choices: [
            "飛行が正常終了した場合は記録を残さなくてよい",
            "異常の有無にかかわらず必要な記録を残す",
            "記録は事故が発生した場合のみ作成する"
        ],
        ...
        explanation:
            "飛行後は運航記録や異常の有無を記録し、継続的な安全管理に役立てます。"
},

{
        ...
        question:
            "無人航空機の飛行における第三者リスク低減策として最も適切なものはどれか。",
...

{
        ...
        question:
            "無人航空機の運航において保険加入が重要とされる理由として最も適切なものはどれか。",
...

{
        ...
        question:
            "事故や重大インシデント発生後の対応として最も適切なものはどれか。",
...

{
        ...
        question:
            "無人航空機の登録制度に関する説明として、不適切なものはどれか。",
        choices: [
            "登録制度は、事故発生時などに所有者を把握し、安全管理を図る目的を有する。",
            "登録記号は、機体に表示する必要がある。",
            "登録を受けた無人航空機であれば、リモートID機能の作動確認や飛行前確認は不要となる。"
        ],
        answer: 2,
        explanation:
            "登録済みであっても、リモートIDや機体状態などの飛行前確認は必要です。登録は安全確認を省略できる制度ではありません。"
},

{
        ...
        question:
            "リモートID機能に関する説明として、不適切なものはどれか。",
        choices: [
            "リモートIDにより、製造番号、登録記号、位置、速度、高度、時刻などが発信される。",
            "リモートIDにより、所有者や使用者の氏名、住所などの個人情報も周囲に発信される。",
            "リモートID機器には内蔵型と外付型がある。"
        ],
        answer: 1,
        explanation:
            "リモートIDで所有者や使用者の個人情報は発信されません。発信されるのは識別情報や位置・速度・高度・時刻などです。"
},

{
        ...
        question:
            "カテゴリーⅡA飛行とカテゴリーⅡB飛行に関する説明として、不適切なものはどれか。",
        choices: [
            "カテゴリーⅡB飛行では、技能証明を受けた者が機体認証を受けた無人航空機を飛行させる場合、一定の場合に許可・承認が不要となる。",
            "カテゴリーⅡA飛行では、技能証明者が機体認証機を飛行させる場合でも、運航管理の方法について審査を受け、許可・承認が必要となる場合がある。",
            "カテゴリーⅡA飛行もカテゴリーⅡB飛行も、技能証明と機体認証の両方がない限り、許可・承認を受けても飛行できない。"
        ],
        answer: 2,
        explanation:
            "カテゴリーⅡA/B飛行は、技能証明や機体認証がない場合でも、必要な許可・承認を受けることで可能となる場合があります。"
},

{
        ...
        question:
            "空港等周辺の空域における飛行に関する説明として、不適切なものはどれか。",
        choices: [
            "空港等周辺の空域では、航空機の離着陸の安全確保のため、無人航空機の飛行が制限される。",
            "空港等周辺であっても、制限高より低い高度であれば、すべての場合に許可なく飛行できる。",
            "空港周辺の飛行可否は、制限表面や地理院地図等で確認する必要がある。"
        ],
        answer: 1,
        explanation:
            "制限高以下で飛行できる場合もありますが、すべての場合に許可不要とは限りません。地理院地図等で確認が必要です。"
},

{
        ...
        question:
            "空港の制限表面に関する説明として、不適切なものはどれか。",
        choices: [
            "進入表面は、航空機の進入最終段階や離陸時の安全確保に関係する。",
            "水平表面は、空港周辺における航空機の旋回飛行等の安全確保に関係する。",
            "円錐表面はすべての空港に必ず設定されており、進入表面、水平表面、転移表面と同じ扱いである。"
        ],
        answer: 2,
        explanation:
            "すべての空港に共通する基本的な制限表面は進入表面、水平表面、転移表面です。円錐表面等は特定の空港で設定されます。"
},

{
        ...
        question:
            "第三者上空の飛行に関する説明として、不適切なものはどれか。",
        choices: [
            "第三者が屋内や停止中の車両内にいて、遮蔽物により保護される場合、第三者上空とはみなされない場合がある。",
            "レベル3.5飛行において、一定の要件を満たす場合、移動中の車両等の上空を一時的に飛行しても第三者上空とみなされない場合がある。",
            "第三者が停車中の観光バスの中にいる場合は、常に移動中の車両等として扱われ、レベル3.5飛行の要件を満たさなくても第三者上空とはみなされない。"
        ],
        answer: 2,
        explanation:
            "停車中の車両と移動中の車両等は扱いが異なります。移動中の車両等についてはレベル3.5飛行など一定の要件が関係します。"
},

{
        ...
        question:
            "模型航空機に関する規制として、不適切なものはどれか。",
        choices: [
            "100g未満の模型航空機であっても、航空機の飛行に影響を及ぼすおそれのある行為は航空法の規制対象となる場合がある。",
            "航空路内の空域や一定高度以上の空域で模型航空機を飛行させる場合、届出が必要となる場合がある。",
            "100g未満の模型航空機は無人航空機に該当しないため、航空法上いかなる空域でも自由に飛行できる。"
        ],
        answer: 2,
        explanation:
            "100g未満で無人航空機に該当しない場合でも、模型航空機として航空法上の規制を受ける場合があります。"
},

{
        ...
        question:
            "小型無人機等飛行禁止法に関する説明として、不適切なものはどれか。",
        choices: [
            "重要施設の敷地・区域の上空や、その周囲おおむね300mの上空が規制対象となる場合がある。",
            "外国要人の来日などに伴い、対象施設が一時的に追加される場合がある。",
            "空港は航空法で規制されるため、小型無人機等飛行禁止法の対象施設となることはない。"
        ],
        answer: 2,
        explanation:
            "国土交通大臣が指定する空港は、小型無人機等飛行禁止法の対象施設となる場合があります。"
},

{
        ...
        question:
            "物件投下に関する説明として、不適切なものはどれか。",
        choices: [
            "農薬や水などの液体・霧状のものを散布する行為も、物件投下に含まれる場合がある。",
            "無人航空機を使って輸送した物件を、落下させずに地表や水面へ置く行為は、物件投下に含まれない場合がある。",
            "水のように危険性が低いものを散布する場合は、物件投下には一切該当しない。"
        ],
        answer: 2,
        explanation:
            "物件投下には、水や農薬などの液体・霧状のものの散布も含まれます。"
...

{
        ...
        question:
            "飛行自粛要請空域に関する説明として、不適切なものはどれか。",
        choices: [
            "国土交通省は、警備上の観点などから無人航空機の飛行自粛を要請することがある。",
            "操縦者は飛行前に飛行自粛要請空域の有無を確認し、要請内容に応じた対応を行う必要がある。",
            "飛行自粛要請空域は航空法上の飛行禁止空域と同じであり、違反した場合は必ず航空法上の罰則対象となる。"
        ],
        answer: 2,
        explanation:
            "飛行自粛要請は法令等に基づく規制そのものではありませんが、操縦者は内容を確認し適切に対応する必要があります。"
},

{
        ...
        question:
            "回転翼航空機（マルチローター）の制御に関する説明として、最も適切なものはどれか。",
        choices: [
            "各ローターの回転数を変化させることで、上昇・降下、前後左右移動、ヨー方向の回転を制御する。",
            "メインローターのピッチ角を周期的に変化させるスワッシュプレートにより、各ローターの揚力を個別に制御する。",
            "各ローターのピッチ角は飛行中に常に変化しており、回転数は一定に保たれる。"
        ],
        answer: 0,
        explanation:
            "マルチローターは、固定ピッチのローターを用い、各ローターの回転数を変化させて姿勢や移動を制御します。"
},

{
        ...
        question:
            "飛行機、回転翼航空機、パワードリフト機の特徴として、最も適切なものはどれか。",
        choices: [
            "飛行機は垂直離着陸やホバリングに優れ、回転翼航空機は高速・長距離飛行に優れる。",
            "回転翼航空機は垂直離着陸やホバリングが可能で、飛行機は速度やエネルギー効率に優れ、パワードリフト機は両者の特徴を組み合わせた機体である。",
            "パワードリフト機は、最大離陸重量25kg以上の大型マルチローターのみを指す。"
        ],
        answer: 1,
        explanation:
            "回転翼航空機は垂直離着陸やホバリング、飛行機は高速・長距離飛行、パワードリフト機は両者の特徴を持つ機体です。"
},

{
        ...
        question:
            "高度計測に用いられるセンサの説明として、最も適切なものはどれか。",
        choices: [
            "LiDARはレーザー光の反射時間などを利用して距離や高度を計測する。",
            "超音波センサは衛星からの信号を利用して高度を計測する。",
            "気圧センサは電波の反射を利用して水平位置を測定する。"
        ],
        answer: 0,
        explanation:
            "LiDARはレーザー光、超音波センサは音波の反射、気圧センサは気圧変化を利用して高度推定に用いられます。"
},

{
        ...
        question:
            "リチウムポリマーバッテリーの特性として、最も適切なものはどれか。",
        choices: [
            "エネルギー密度が高く、自己放電が少ない一方、電解質が可燃物であるため取扱いに注意が必要である。",
            "電解質は不燃物であり、過充電や短絡が発生しても発火のおそれはない。",
            "メモリ効果が大きいため、継ぎ足し充電を避けなければ必ず容量が急激に低下する。"
        ],
        answer: 0,
        explanation:
            "リチウムポリマーバッテリーは高エネルギー密度・自己放電の少なさなどの利点がある一方、電解質が可燃物であり、過充電、短絡、衝撃等に注意が必要です。"
},

{
        ...
        question:
            "無人航空機で使用される電波に関する説明として、最も適切なものはどれか。",
        choices: [
            "通信可能距離は、周波数帯、出力、アンテナ特性、変調方式、伝送速度などにより変動する。",
            "2.4GHz帯は無人航空機専用であり、Wi-Fiなど他の用途では使用されない。",
            "169MHz帯は、常に操縦用の主回線として使用しなければならない。"
        ],
        answer: 0,
        explanation:
            "通信可能距離は周波数帯や出力、アンテナ特性、変調方式、伝送速度などで変動します。2.4GHz帯はWi-Fi等でも使用されます。"
},

{
        ...
        question:
            "送信機アンテナの取扱いに関する説明として、不適切なものはどれか。",
        choices: [
            "アンテナから発射される電波の強さは方向によって異なるため、機体位置や送信機の持ち方を考慮する必要がある。",
            "アンテナ角度は通信品質に影響する場合があるため、機体との位置関係に応じて調整する。",
            "アンテナ角度を調整すると、機体の飛行速度や高度そのものを直接変化させることができる。"
        ],
        answer: 2,
        explanation:
            "アンテナ角度は通信状態に影響する場合がありますが、機体の速度や高度を直接変化させるものではありません。"
},

{
        ...
        question:
            "リチウムポリマーバッテリーの保管・取扱いとして、不適切なものはどれか。",
        choices: [
            "長期間使用しない場合は、満充電や完全放電ではなく、おおむね60%程度を目安に保管する。",
            "短絡、強い衝撃、高温、水濡れを避けて保管する。",
            "飛行後すぐに使えるよう、満充電の状態で長期間保管することが推奨される。"
        ],
        answer: 2,
        explanation:
            "満充電での長期保管は推奨されません。長期保管ではおおむね60%程度を目安とし、高温や短絡等を避けます。"
        },
        ...
        question:
            "大型の無人航空機に関する説明として、不適切なものはどれか。",
        choices: [
            "機体が大型化すると慣性力が大きくなり、増速・減速・上昇・降下に要する時間や距離が長くなる。",
            "大型機はペイロードや動力源の選択肢が広がる一方、事故時の影響や騒音にも注意が必要である。",
            "大型機はモーターパワーやローターが大きくなるため、加減速や停止に要する距離は小型機より短くなる。"
        ],
        answer: 2,
        explanation:
            "大型機は慣性力が大きくなるため、加減速、上昇、降下などに要する時間や距離が長くなる傾向があります。"
},

{
        ...
        question:
            "夜間飛行における機体装備とセンサに関する説明として、不適切なものはどれか。",
        choices: [
            "夜間飛行では、機体の姿勢や方向を視認できる灯火が必要となる場合がある。",
            "ビジョンセンサーは暗所で正常に機能しない場合があり、衝突回避や姿勢安定に影響することがある。",
            "灯火を有し、飛行範囲が照明で十分明るければ、航空法上の夜間飛行の承認は常に不要となる。"
        ],
        answer: 2,
        explanation:
            "灯火や照明条件が整っていても、航空法上の夜間飛行に該当する場合は承認が必要です。"
},

{
        ...
        question:
            "物件投下装置の取扱いに関する説明として、不適切なものはどれか。",
        choices: [
            "装置の搭載位置や対象物の特性を理解し、重心移動や揺れを考慮する必要がある。",
            "ウインチ等で物件を吊り下げる場合、物件の揺れや投下前後の重心変化に注意する必要がある。",
            "物件投下装置は物件が揺れない構造であるため、装着位置が正しければ重心移動を考慮する必要はない。"
        ],
        answer: 2,
        explanation:
            "物件投下装置を用いる場合でも、物件の揺れや重心移動、投下前後の機体特性の変化を考慮する必要があります。"
},

{
        ...
        question:
            "CRM（Crew Resource Management）の考え方として最も適切なものはどれか。",
        choices: [
            "操縦技量のみを向上させることで事故を防止する考え方",
            "利用可能な人的・物的資源及び情報を活用して安全性を向上させる考え方",
            "自動操縦を活用して人的判断を排除する考え方"
        ],
        answer: 1,
        explanation:
            "CRMは人的資源・機材・情報を有効活用して安全性向上を図る考え方です。"
},

{
        ...
        question:
            "TEM（Threat and Error Management）の説明として最も適切なものはどれか。",
        choices: [
            "事故発生後の原因究明を目的とした分析手法",
            "スレットやエラーを早期に把握し事故へ発展する前に対処する手法",
            "操縦者の技量のみで危険を回避する訓練手法"
        ],
        answer: 1,
        explanation:
            "TEMは脅威やエラーを早期把握し、事故に発展する前に管理する考え方です。"
},

{
        ...
        question:
            "飛行計画作成時の対応として最も適切なものはどれか。",
        choices: [
            "飛行経験のある場所では飛行計画は省略できる",
            "緊急着陸地点や代替経路も含めて計画する",
            "飛行当日の判断に委ねるため事前計画は不要である"
        ],
        answer: 1,
        explanation:
            "飛行経験の有無に関係なく飛行計画を立案し、緊急時対応も含める必要があります。"
},

{
        ...
        question:
            "補助者を配置する場合の運用として最も適切なものはどれか。",
        choices: [
            "操縦者との連絡方法や役割分担を事前に明確化する",
            "補助者は操縦者の指示を待つだけでよい",
            "補助者は技能証明保持者でなければならない"
        ],
        answer: 0,
        explanation:
            "補助者との役割分担や連絡方法は飛行前に明確化しておく必要があります。"
},

{
        ...
        question:
            "飛行中の監視について最も適切なものはどれか。",
        choices: [
            "衝突防止装置搭載機では目視監視は不要",
            "周囲監視は最大の安全対策であり継続して行う",
            "監視は補助者だけが実施すればよい"
        ],
        answer: 1,
        explanation:
            "衝突防止機能を過信せず、周囲監視を継続することが重要です。"
},

{
        ...
        question:
            "操縦者の体調管理として最も適切なものはどれか。",
        choices: [
            "多少の睡眠不足であれば飛行を優先する",
            "体調不良時は判断力低下の可能性があるため飛行を見合わせる",
            "体調管理は飛行技能と無関係である"
        ],
        answer: 1,
        explanation:
            "体調不良や疲労は事故要因となるため、無理な飛行は避けます。"
},
...

{
        ...
        question:
            "第三者に対する操縦者の責任として最も適切なものはどれか。",
        choices: [
            "第三者が近づいた場合は自己責任である",
            "第三者が容易に近づけない飛行経路を選定する",
            "飛行許可取得後は第三者への配慮は不要である"
        ],
        answer: 1,
        explanation:
            "第三者の安全確保は操縦者の重要な責任です。"
},

{
        ...
        question:
            "操縦者の責任に関する説明として不適切なものはどれか。",
        choices: [
            "飛行全体の安全確保は操縦者の責任である",
            "事故時には民事責任や刑事責任を負う場合がある",
            "補助者を配置した場合は操縦者の責任は補助者へ移る"
        ],
        answer: 2,
        explanation:
            "補助者を配置しても最終責任は操縦者にあります。"
},

{
        ...
        choices: [
            "最新の気象情報を収集する",
            "飛行経験のある場所なので現地調査を省略する",
            "緊急着陸地点を検討する"
        ],
        answer: 1,
        explanation:
            "飛行経験のある場所でも現地調査や計画は必要です。"
},

{
        ...
        choices: [
            "第三者の立入管理を行う",
            "操縦者との連絡方法を事前確認する",
            "危険を発見しても操縦者へ伝える必要はない"
        ],
        answer: 2,
        explanation:
            "補助者は危険情報を操縦者へ伝達する重要な役割があります。"
},
...

{
        ...
        question:
            "TEMに関する説明として不適切なものはどれか。",
        choices: [
            "スレットの早期把握を行う",
            "エラー発生時の対応を考慮する",
            "操縦者単独で全て解決することを前提とする"
        ],
        answer: 2,
        explanation:
            "TEMは利用可能な全リソースを活用する考え方です。"
},
...

{
        ...
        answer: 2,
        explanation:
            "CRMはノンテクニカルスキルであり整備技術そのものではありません。"
},
...

{
        ...
        question:
            "夏季の海岸付近で午後に無人航空機を飛行させる場合の気象リスクとして最も適切なものはどれか。",
        choices: [
            "海陸風の影響により日中は海から陸へ向かう風が強まる可能性がある",
            "海陸風は夜間のみ発生するため考慮不要である",
            "海岸付近では局地風は発生しない"
        ],
        answer: 0,
        explanation:
            "海陸風は沿岸部特有の局地風であり、日中は海から陸へ風が吹く傾向があります。"
},

{
        ...
        answer: 1,
        explanation:
            "寒冷前線では発達した積乱雲に伴う突風・雷・急激な気象変化に注意します。"
},

{
        ...
        question:
            "ダウンバーストに関する説明として最も適切なものはどれか。",
        choices: [
            "積乱雲からの強い下降流が地表で四方へ広がる現象",
            "海陸風が急激に強くなった状態",
            "高層ビル周辺だけで発生する局地風"
        ],
        answer: 0,
        explanation:
            "ダウンバーストは積乱雲からの下降流が地表に衝突し周囲へ広がる危険な現象です。"
},

{
        ...
        question:
            "夏季の広いアスファルト駐車場上空で飛行する場合のリスクとして最も適切なものはどれか。",
        choices: [
            "地表加熱による上昇気流やつむじ風",
            "気流変化は発生しない",
            "下降気流のみ発生する"
        ...
        answer: 0,
        explanation:
            "アスファルトは加熱されやすく、上昇気流や局地的な渦が発生することがあります。"
},

{
        ...
        question:
            "山岳地帯で昼間に飛行する際の気象現象として最も適切なものはどれか。",
        choices: [
            "冷気が山から吹き下ろす山風が卓越する",
            "暖められた空気が谷を上昇する谷風が発生しやすい",
            "昼夜を通じて風向は変化しない"
        ],
        answer: 1,
        explanation:
            "昼間は谷風、夜間は山風が発生しやすいことを理解しておく必要があります。"
},

{
        ...
        question:
            "操縦者Aは夏季午後に海岸付近で空撮を実施する計画を立てた。飛行前には天気予報を確認し、風速は機体性能の範囲内であったが、現地到着後に海側から陸側へ継続的な風が吹いていることを確認した。この状況における対応として不適切なものはどれか。",
        choices: [
            "海陸風による局地的な風速変化を考慮して飛行計画を見直す",
            "離陸地点と着陸地点で風向が変化する可能性を考慮する",
            "天気予報で問題なかったため現地での風向確認は不要と判断する"
        ],
        answer: 2,
        explanation:
            "局地風は天気予報だけでは把握できない場合があり、現地確認が重要です。"
},

{
        ...
        question:
            "操縦者Bは河川敷で自動操縦飛行を実施していた。飛行中、遠方に積乱雲が発達し始めたが、現在地点は晴天であり機体も正常であった。この状況での判断として不適切なものはどれか。",
        choices: [
            "飛行継続中も雷鳴や風向変化を監視する",
            "積乱雲の接近を考慮し帰還準備を行う",
            "現在晴れているため積乱雲の影響はないと判断し飛行を続行する"
        ],
        answer: 2,
        explanation:
            "積乱雲は突風やダウンバーストを発生させる可能性があります。"
},

{
        ...
        question:
            "操縦者Cは物流飛行の経路設定を行っている。飛行経路の一部には送電線があり、その付近を通過しなければならない。経路設定に関する説明として不適切なものはどれか。",
        choices: [
            "障害物との距離を現地確認する",
            "必要に応じて補助者を配置する",
            "GPS精度を信頼し現地確認は不要と判断する"
        ],
        answer: 2,
        explanation:
            "現地調査を行わずGPSだけに依存することは危険です。"
},

{
        ...
        question:
            "操縦者Dは飛行経験が豊富であり、以前にも同じ場所で多数の飛行実績があった。今回も同じ場所で飛行する予定である。この状況における考え方として不適切なものはどれか。",
        choices: [
            "過去実績があっても最新の気象情報を確認する",
            "周辺環境の変化を確認するため現地調査を行う",
            "経験が十分あるため飛行計画や現地調査は不要である"
        ],
        answer: 2,
        explanation:
            "経験の有無に関わらず飛行計画と現地調査は必要です。"
},

{
        ...
        question:
            "操縦者Eは夏季の日中に大型商業施設の駐車場上空で飛行を行う予定である。施設周辺にはアスファルト舗装面や大型建築物が多数存在する。この環境におけるリスク評価として不適切なものはどれか。",
        choices: [
            "ビル風や吹き降ろしの発生可能性を考慮する",
            "地表加熱による上昇気流を考慮する",
            "大型建築物があっても気流への影響はほとんどないと判断する"
        ],
        answer: 2,
        explanation:
            "建築物や地表加熱は気流に大きな影響を与えるためリスク評価が必要です。"
},
